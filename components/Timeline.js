        ...
        >
          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-row w-full items-center">
              <span className="text-sm font-semibold flex items-center whitespace-nowrap overflow-hidden overflow-ellipsis">
                {e.author}
              </span>
              {e.verified ? (
                  <svg
              ...
              <span className="mx-1 inline-block text-sm font-normal text-gray-700 items-center overflow-hidden whitespace-nowrap overflow-ellipsis">
                @{e.user}
              </span>
              <span className="inline-block text-sm font-normal text-gray-700 items-center overflow-hidden whitespace-nowrap overflow-ellipsis">
                · {e.date}
              </span>
            </div>
